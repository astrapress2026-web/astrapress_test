...
const defaultConfig: SiteConfig = {
  ...
  fontFamily: 'sans',
  logoUrl: 'https://picsum.photos/seed/astrapress-logo/200/200',
  seoTitle: '아스트라프레스 (Astrapress)',
  seoDescription: '현대적이고 전문적인 디자인의 출판사 웹사이트',
  heroTitle: '지혜의 별을 잇다.',
  heroSubtitle: '아스트라프레스는 시대를 관통하는 지혜와 이야기를 담아냅니다. 우리는 책을 통해 새로운 세상을 열고, 독자와 함께 성장합니다.',
  heroImageUrl: 'https://picsum.photos/seed/astrapress-hero/800/1000',
  footerLogoUrl: '',
  booksLink: 'books',
  authorSupportLink: '',
  address: '서울특별시 강남구 테헤란로 123',
  email: 'contact@astrapress.com',
  phone: '02-1234-5678',
  menus: [
    { label: '홈', view: 'home' },
